...
% [ip, fs] = audioread('trimed_E4_mono48kHz.wav');
% [ip, fs] = audioread('trimed_E4_mono96kHz.wav');
% [ip, fs] = audioread('trimed_E4_mono192kHz.wav');

% [ip, fs] = audioread('trimed_E2_mono48kHz.wav');
% [ip, fs] = audioread('trimed_E2_mono96kHz.wav');
[ip, fs] = audioread('trimed_E2_mono192kHz.wav');
f_prob = fs;
